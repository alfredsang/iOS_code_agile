...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    RootViewControllerViewController *v = [RootViewControllerViewController new];
    v.view.frame = self.window.frame;
    ...
    XIBTooRViewController *v = [XIBTooRViewController new];
    v.view.frame = self.window.frame;
    [self.window addSubview:v.view];
